        ...
        <div class="flex flex-col sm:flex-row items-center md:items-start sm:justify-center md:justify-start flex-auto min-w-0 ">
          ...
          >
            ...
            <g>
                ...
                <p class="mt-10 text-4xl text-gray-200">Join upHiphop today.</p>
              </div>
              ...
              <div>
                <button
                  type="submit"
                  class="lg:w-3/5 w-full flex justify-center text-black p-4   rounded-full tracking-wide font-bold  focus:outline-none focus:shadow-outline hover:bg-indigo-600 shadow-lg bg-up cursor-pointer transition ease-in duration-300"
                >
                  Sign up
                </button>
              </div>
              <div>
                  <button
                    type="submit"
                    class="lg:w-3/5 w-full flex justify-center border-up bg-transparent text-gray-100 p-4 border rounded-full tracking-wide font-semibold  focus:outline-none focus:shadow-outline hover:bg-gray-900 shadow-lg cursor-pointer transition ease-in duration-300"
                  >
                    Log in
                  </button>
              </div>
